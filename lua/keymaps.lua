...
-- Diagnostic keymaps
vim.keymap.set('n', '<leader>mp', vim.diagnostic.goto_prev, { desc = 'Go to previous [D]iagnostic message' })
vim.keymap.set('n', '<leader>mn', vim.diagnostic.goto_next, { desc = 'Go to next [D]iagnostic message' })
